  ...
  if (isDesktop) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue to-navy flex flex-col items-center justify-center p-8 text-center">
        ...
        <p className="text-white/50 text-xs mb-6 tracking-widest uppercase">Officer & Admin Portal</p>
        ...
        <p className="text-white/60 text-sm max-w-xs leading-relaxed">
          The Organizer Portal is designed for mobile and tablet screens. Use it on your phone or tablet at the venue for QR scanning and event management.
        </p>
