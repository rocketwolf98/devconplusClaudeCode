...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-navy flex flex-col max-w-lg mx-auto">
      {/* Gradient header */}
      <div className="bg-gradient-to-b from-navy to-blue px-6 pt-16 pb-10 text-center">
        ...
        <p className="text-white/60 mt-1 text-sm">Chapter Officer &amp; Admin Portal</p>
      </div>
      ...
      <div className="flex-1 bg-slate-50 rounded-t-3xl px-6 pt-8 pb-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {error && (
            <p className="text-xs text-red bg-red/5 border border-red/20 rounded-lg px-3 py-2">
              {error}
            </p>
          )}
