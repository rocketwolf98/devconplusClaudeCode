...
import { CloseSquareOutline, ShieldCheckOutline, MonitorOutline } from 'solar-icon-set'
          ...
          >
            <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-sm relative">
              ...
              <button
                ...
                aria-label="Close"
              >
                <CloseSquareOutline className="w-5 h-5" />
              </button>
                  ...
                  <>
                    <div className="flex justify-center mb-4">
                      <div className="w-14 h-14 rounded-2xl bg-blue/10 flex items-center justify-center">
                        <ShieldCheckOutline className="w-7 h-7 text-blue" />
                      </div>
                    </div>
                  ...
                  <>
                    <div className="flex justify-center mb-4">
                      <div className="w-14 h-14 rounded-2xl bg-slate-100 flex items-center justify-center">
                        <MonitorOutline className="w-7 h-7 text-slate-400" />
                      </div>
                    </div>
