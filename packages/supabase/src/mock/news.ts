...
export const NEWS_POSTS: NewsPost[] = [
  {
    ...
    is_featured: true,
    is_promoted: false,
    cover_image_url: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=800&q=80&fit=crop',
    author_id: null,
  ...
  },
  {
    ...
    is_featured: false,
    is_promoted: true,
    cover_image_url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=800&q=80&fit=crop',
    author_id: null,
  ...
  },
  {
    ...
    is_featured: false,
    is_promoted: true,
    cover_image_url: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&q=80&fit=crop',
    author_id: null,
